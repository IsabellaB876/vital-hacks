...
//     navigate("/Kanbas/Account/Profile");
  return (
    <div className="wd-signup-screen">
      ...
      <Link  to="/PatientHome" > <Button className="wd-signup-btn btn btn-primary mb-2 w-100"> Sign up (Patient) </Button> </Link><br />
      <Link  to="/DoctorHome" > <Button className="wd-signup-btn btn btn-primary mb-2 w-100"> Sign up (Doctor) </Button> </Link><br />
